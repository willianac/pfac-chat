...
function ChatLayout({ children, userList }: LayoutProps) {
	...
	return (
		<div className="w-full flex justify-center mt-12 md:mt-24">
			<Box minH={"650px"} w={"65%"} p={6} rounded={6} className="flex flex-col md:flex-row bg-zinc-900 flex-1 md:flex-initial gap-y-6">
				...
				<div className="flex-1 md:ml-6 bg-zinc-950 rounded-lg p-2 md:p-4">
					{children}
				</div>
			</Box>
		</div>
